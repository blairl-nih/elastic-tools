...
/*
    ...
    with itif(ON_GITHUB) provides a convenient way to accomplish this goal.
*/
...
describe('ElasticTools', () => {
    ...
    describe('optimizeIndex', () => {
        ...
        //but it would slow down regular tests, so we use itif(ON_GITHUB) to make it conditional.
        //itif(ON_GITHUB)
        ...
        //itif(ON_GITHUB)
        it.only("optimizes the index with delay", async() => {
            const indexName = 'bryantestidx';
